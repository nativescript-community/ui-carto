...
export declare function fromNativeMapPos(pos: com.carto.core.MapPos): MapPos;
export declare function toNativeMapPos(pos: MapPos): com.carto.core.MapPos;
...
export declare class MapPosVector extends NativeVector<com.carto.core.MapPos> {
    ...
    constructor();
    add(pos: com.carto.core.MapPos | MapPos): void;
}
export declare class MapPosVectorVector extends NativeVector<com.carto.core.MapPosVector> {
    ...
    constructor();
    add(pos: com.carto.core.MapPosVector | MapPosVector): void;
}
