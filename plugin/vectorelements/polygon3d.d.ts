...
import { BaseLineVectorElement, BaseVectorElementStyleBuilder, LineVectorElementOptions } from './vectorelements';
// import { LineStyleBuilder } from './line';
import { Color } from 'tns-core-modules/color/color';
import { MapPosVector, MapPosVectorVector } from '../core/core';
export class Polygon3DStyleBuilderOptions extends LineVectorElementOptions {
    size?: number;
    color?: string | Color;
