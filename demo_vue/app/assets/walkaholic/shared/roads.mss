...
//#transportation{
//  ::polygon{
//    [class='path']['mapnik::geometry_type'=3][zoom>=12]{
//      polygon-fill: @path_poly;
//      polygon-opacity: linear([view::zoom], (12.0, 0.0), (14.5, 0.7));
//    }
//  }
//  ::case{ }
//  ::fill{ }
...
#transportation{
  ...
  [class='tertiary'][ramp=1]['mapnik::geometry_type'=2][zoom>=11]{
    ::case{
      ...
      [class='tertiary']{
        ...
        line-width: linear([view::zoom], (12, 0.8), (14, @14_hwy_f/2.0 + 1.0), (15, @15_hwy_f/2.0 + 2.0), (16, @16_hwy_f/2.0 + 2.0), (17, @17_hwy_f/2.0 + 2.0), (18, @18_hwy_f/2.0 + 2.0));
      }
  ...
  [class='service']['mapnik::geometry_type'=2][zoom>=12]{
    ::case{
      ...
      line-join: round;
      line-color: linear([view::zoom], (12, @minor_case));
      line-width: linear([view::zoom], (12, 0.0), (14, @15_min_f/4.0*2.0), (16, @16_min_f/2.0*2.0), (17, @17_min_f/2.0*2.0), (18, @18_min_f/3.0*2.0));
      [brunnel='tunnel'] { line-color: @tunnel_case; }
    }
    ::fill{
      line-color: @street;
      line-cap: [zoom]<=15 ? butt : round;
      line-join: round;
      line-width: linear([view::zoom], (12, 0.0), (14, @16_min_f/2.0), (17, @17_min_f/2.0), (18, @18_min_f/3.0));
      [brunnel='tunnel'] { line-color: @tunnel; }
    }
  }

  [class='track']['mapnik::geometry_type'=2][zoom>=12],
  [class='path']['mapnik::geometry_type'=2][zoom>=12]{
    ::case{
      line-cap: butt;
      line-color: @path;
      line-opacity: 0.9;
      line-width: linear([view::zoom], (14, 0.5), (15, 1), (17, 2.0), (18, 2.5));
