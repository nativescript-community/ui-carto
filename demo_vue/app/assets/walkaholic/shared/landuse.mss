...
#landuse[class='stadium']{
  ...
  polygon-fill: linear([view::zoom], (8, rgba(130, 191, 90, 0.0)), (11, rgba(130, 191, 90, 0.6)), (15, rgba(130, 191, 90, 0.7)));
  ...
  //beach
  #landcover[class='sand'][zoom>=8],
  #landcover[subclass='sand'][zoom>=8] {
    polygon-fill: @beach;
    polygon-gamma: 0.75;
  }
}
