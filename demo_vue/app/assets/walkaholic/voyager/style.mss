...
//Base Colors
@landmass_fill:             #e1e0ce; //lighten(#F8F3EB,2); #fbf8f3
...
@greenareas:             rgba(130, 191, 90, 0.7); //#82bf5a;//#C5E1B2;
@greenarea_fade_1:       fadeout(@greenareas,80);//rgba(197, 225, 178, 0.2);
@greenarea_fade_2:       fadeout(@greenareas,80);//rgba(197, 225, 178, 0.25);
@greenarea_fade_3:       fadeout(@greenareas,80);//rgba(197, 225, 178, 0.35);
@greenarea_fade_4:       fadeout(@greenareas,70);//rgba(197, 225, 178, 0.4);

@green_area_highzoom:    rgb(224,236,211); //#e0ecd3;
@pattern_opacity:        0;
